...
const Card = ({ learnmore, icon, title, des }) => {
  return (
    <div
      id="serviceCard"
      className="group w-full md:max-w-[370px] cursor-pointer shadow-md hover:-translate-y-4 
    ...
    >
      <div className="p-[20px] rounded-[10px] border-2 border-thirdColor">
        <Image src={icon ? icon : home} alt={icon} className="w-5 lg:w-10" />
      </div>
      <h3 className="font-openSans font-bold max-w-[290px] text-nowrap overflow-hidden text-ellipsis text-primary text-center text-lg lg:text-2xl lg:pt-[30px] pt-5 pb-5">
        {title ? title : "Home insurance "}
      </h3>
      <p className="max-w-[250px] font-openSans font-normal pb-3 lg:pb-5 text-sm lg:text-base text-secondary text-center">
        {des
          ? des
      ...
      {learnmore ? (
        <div className="flex items-center gap-x-1 font-openSans font-bold text-base text-primary">
          <p className="font-openSans font-bold text-sm lg:text-base text-primary">
            Learn more
          </p>
